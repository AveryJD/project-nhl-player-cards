...
def make_specific_player_cards(specific_players: list, cur_season: str, pos: str, mode: str = 'light') -> None:
    """
    ...
    for player_name in specific_players:
        cf.make_player_card(player_name, cur_season, pos, mode=mode)
...
def make_position_player_cards(season: str, pos: str, mode: str = 'light') -> None:
    """
...
def make_rank_player_cards(rank: str, season: str, pos: str, mode: str = 'light') -> None:
    """
